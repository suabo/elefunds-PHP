...
use Lfnds\Example\RawDataConfiguration;
use Lfnds\Exception\ElefundsCommunicationException;
use Lfnds\Facade;

require_once __DIR__ . '/../src/Lfnds/Facade.php';
require_once __DIR__ . '/RawDataConfiguration.php';

// Set up API
$facade = new Facade();
$facade->setConfiguration(new RawDataConfiguration());
...
// 1. Generate a donation class for your backend and implement the Lfnds\Donation\DonationInterface
...
// 4. That's it.
//
// Hint: The elefunds shopware module does that trick with doctrine, check it out at https://github.com/elefunds/elefunds-Shopware!
